...
import com.example.restdocs.MarkdownWriterResolver;
...
public class ApiDocumentation {
	...
	public void setUp() {
		this.mockMvc = MockMvcBuilders.webAppContextSetup(this.context)
				.apply(documentationConfiguration(this.restDocumentation).writerResolver(new MarkdownWriterResolver())).build();
	}
